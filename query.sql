...
CREATE TABLE Driver            (id CHAR(10) NOT NULL,
...
CREATE TABLE Area 	           (id CHAR(10) NOT NULL,
								name VARCHAR(30) NOT NULL,
...
CREATE TABLE Route 	 		   (id CHAR(10) NOT NULL UNIQUE,
								duration_in_min INT,
								PRIMARY KEY (id));

CREATE TABLE Violation  	   (id CHAR(10) NOT NULL UNIQUE,
...
CREATE TABLE Traffic_light 	   (id CHAR(10) NOT NULL UNIQUE,
...
CREATE TABLE Parking_slot 	   (id CHAR(10) NOT NULL UNIQUE,
...
CREATE TABLE Tolls 			   (id CHAR(10) NOT NULL UNIQUE,
								location CHAR(24),
								toll_in_euros FLOAT,
								area_id CHAR(10),
								PRIMARY KEY (id, area_id),
...
CREATE TABLE Route_Area        (route_id CHAR(10) NOT NULL,
								area_id CHAR(10) NOT NULL,
								PRIMARY KEY (route_id, area_id),
								FOREIGN KEY (route_id) REFERENCES Route(id),
								FOREIGN KEY (area_id) REFERENCES Area(id));                  
                         
CREATE TABLE Neighboring_Areas (area1_id CHAR(10) NOT NULL,
